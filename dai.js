...
const channelList = [
  {
    name: 'Channel 1. DAI DEMO Stream', 
    dai: true,
  },
  {
    name: 'Channel 2. HD DEMO Stream', 
    url: 'https://demo-hls7-live.zahs.tv/hd/master.m3u8',
  },
  {
    name: 'Channel 3. Full HD DEMO Stream', 
    url: 'https://demo-hls7-live.zahs.tv/fullhd/master.m3u8',
  },
];
...
function channelUp() {
  channel = (channel + 1) % channelList.length;
  loadStream();
}
 ...
 */
function loadStream() {
  const currentChannel = channelList[channel];
  document.getElementById('channel').innerHTML = currentChannel.name;
...
/**
 * Play video (In case it's autoplay block with unmuted video)
 */
function play() {
  hls.media.play();
}
